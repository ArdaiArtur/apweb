...
<div id="card"> 
    ...
    <form >
        ...
        <input type="text" id="text" name="user_name" placeholder="Jhony" required><br>
        <br>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        <label for="Parola">Password:</label>
        <input type="password" id="text" name="password" placeholder="***********"
        ...
        <input type="email" id="text" name="email" placeholder="Jhony@gmail.com" required><br>
        <br>
        
        <label for="Sex" >Sex:</label>
        <input type="radio" id="text" name="man" required>
        ...
        <input type="text" id="text" name="age" required><br>
        <br>
